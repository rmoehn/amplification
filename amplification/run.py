...
def main_cmd():
    ...
    for c in [
            ...
            'task.nchars', 'task.log_iters', 'model.ema_horizon',
            'model.scale_weights', 'model.depth', 'model.nh',
            'train.curriculum', 'train.random_subset', 'train.loss_threshold',
            'train.nbatch', 'train.path', 'train.buffer_size',
            'train.log_frequency', 'train.generation_frequency',
